...
const DEENME_EDGE_URL = 'https://[DEENME-PROJECT-ID].supabase.co/functions/v1/get-deenme-pin';
...
export function DeenmeCard() {
  ...
  if (loading) return (
    <div style={{
      ...
      <div style={{ fontSize: 12, color: '#666' }}>Mengecek akses Deenme...</div>
    </div>
  );
  ...
  if (!active) return (
    <div style={{
      ...
      <div style={{ fontSize: 11, color: '#f59e0b', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 8 }}>
    ...
    <div style={{
      ...
      <div
        ...
        style={{
          ...
          padding: '12px 18px', fontFamily: 'monospace', fontSize: 22,
          fontWeight: 800, color: '#f0a500', letterSpacing: 6,
          cursor: 'pointer', display: 'inline-flex', alignItems: 'center',
          gap: 12, marginBottom: 16, userSelect: 'all',
        }}
      >
        {pin}
        <span style={{ fontSize: 13, color: '#555', fontFamily: 'sans-serif', fontWeight: 400, letterSpacing: 0 }}>
          {copied ? '✓ Disalin!' : '📋'}
        </span>
      </div>
      ...
      <a
        ...
        style={{
          display: 'block', width: '100%', background: '#4ade80',
          color: '#0a1a0a', borderRadius: 12, padding: '14px 0',
