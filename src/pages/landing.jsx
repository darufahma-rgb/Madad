      ...
      <div className="max-w-3xl mx-auto text-center flex flex-col items-center">
        ...
        <Reveal delay={340}>
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 mb-16">
            {["68 Maddah lengkap (S1 + Ma'had)","800+ template prompt","Bayar sekali, akses selamanya"].map((t, i) => (
...
const HowItWorks = () => {
  const steps = [
    ...
    { num:"03", title:"Mulai belajar", sub:"Workflow + 800+ prompt",
    ...
    <section className="section pt-0">
      <div className="container-x">
        ...
        <Reveal className="mt-10 text-center">
          <p className="text-sm text-ink-soft">Total 800+ template prompt · Disesuaikan untuk Ma'had, DL, sampai S2</p>
        </Reveal>
      </div>
    </section>
  );
    ...
    <div className="container-x">
      <Reveal className="text-center mb-10">
        ...
        <p className="text-ink-muted text-base md:text-lg mt-4 max-w-xl mx-auto leading-relaxed">
          Dapatkan 800+ Prompt siap pakai untuk bantu kamu belajar + update selamanya
        </p>
      </Reveal>
          ...
          <div className="card-glass-strong p-8 md:p-10 relative overflow-hidden"
            ...
            <div className="relative">
              ...
              <ul className="space-y-3 mb-8">
                {[
                  "68 Maddah lengkap (S1 + Ma'had) + 800+ template prompt",
