  ...
  return (
    <div className="page-enter">
      <PageHeader
        ...
        subtitle="Talqeeh tidak menyediakan AI — Talqeeh memberi panduan langkah demi langkah cara pakainya untuk setiap mata pelajaranmu. Buka Claude. Pakai prompt ini. Pahami lebih dalam."
      />
          ...
          <Reveal>
            <div className="card-glass p-5 mb-8 flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-ink-muted leading-relaxed">Pilih mata pelajaran → baca panduan → buka AI yang direkomendasikan → pakai prompt yang sudah disiapkan. Bukan AI-nya yang kamu dapatkan dari Talqeeh, tapi <em className="text-ink not-italic">panduan cara pakainya</em>.</p>
              </div>
            </div>
          </Reveal>
